defmodule Rampart.MixProject do
  ...
  defp run_evaluation(arguments) do
    ...
    files = [
      ...
      "evaluation/fixtures/historical/resource_length/fixture.ex",
      "evaluation/fixtures/historical/incremental_buffer/fixture.ex",
      "evaluation/fixtures/historical/numeric_work/fixture.ex",
